...
data "aws_iam_policy_document" "this" {
  ...
  statement {
    ...
    resources = var.create_cloudwatch_log_group ? [aws_cloudwatch_log_group.this[0].arn] : [var.cloudwatch_log_group_arn]
    # resources = [arn:aws:logs:us-west-2:660548353186:log-group:/emr-on-eks-logs/emr-workload/emr-workload-ns:*]
  }
}
